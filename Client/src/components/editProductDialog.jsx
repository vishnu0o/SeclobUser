...
import {
  ...
  ProductCreateAction,
  ProductEditAction,
  ProductFindOneAction
} from "../Redux/Action/productAction";

const EditProductForm = ({ open, handleClose, id }) => {
  ...
  useEffect(() => {
    if (productFindOneSuccess) {
      setTitle(productFindOneSuccess?.data?.title);
      setVariants(productFindOneSuccess?.data?.variant);
      setSubCategory(productFindOneSuccess?.data?.subCategory);
      setDescription(productFindOneSuccess?.data?.description);
      setImages(productFindOneSuccess?.data?.image);
    }
  ...
  const handleProductAdd = () => {
    ...
    dispatch(ProductEditAction(formData));
    handleClose();
  };
